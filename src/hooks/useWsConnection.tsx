...
import { wsManager } from '../lib/binance/BinanceWebSocket';
import {
  transformMiniTicker,
  type MiniTickerRaw,
} from '../lib/binance/transformers/miniTicker';
...
const miniTickerSubscriptionHandler = (data: unknown) => {
  ...
  const trackedSymbols = new Set(
    Object.keys(useExchangeInfoStore.getState().symbolInfo),
  );
